...
//////////////////////////////////////////////////////////////////////////////
//////////////////// https://github.com/Qata/MonadicJSON /////////////////////
//////////////////////////////////////////////////////////////////////////////
...
extension Data {
    static func from(_ json: Any) -> Data? {
...
let doubles = parseJsonDoubleArray("[5, 3.133]")
doubles[0]
doubles[1]

/////////////////////////////////////////////////////////////////////
let w2 = "🔥 parse to Decimal"
...
/////////////////////////////////////////////////////////////////////
let w4 = "🔥 parse ProductRange"

struct InfoKey: Codable {
    let products: [ProductRange]
    
    enum CodingKeys: String, CodingKey {
        case products = "MASResponseInfoBodyInfoKey"
    }
}

struct ProductRange: Codable {
    let id: Int
    let idProduct: Int
    let minParcel: Decimal
    let minCarta: Decimal
    let featurePhrase: [String]
    
    enum CodingKeys: String, CodingKey {
        case id = "id"
        case idProduct = "idProduto"
        case minParcel = "minParcela"
        case minCarta = "minCarta"
        case featurePhrase = "fraseDestaque"
    }
}

let dictRange: [String: Any] = [
    "MASResponseInfoBodyInfoKey": [
        ["fraseDestaque": ["Um carro pro meu dia a dia"],
         "id": 1,
         "idProduto": 101,
         "minCarta": 20915.09,
         "minParcela": 292.69],
        ["fraseDestaque": ["Um carro para trabalhar"],
         "id": 2,
         "idProduto": 101,
         "minCarta": 60390,
         "minParcela": 607.56],
...
let infoBodyJSON = dictRange["MASResponseInfoBodyInfoKey"] as? Array<[String: Any]>

let jsonDataRange = jsonStringRange.data(using: .utf8)!
let decoderRange = MonadicJSONDecoder()//JSONDecoder()
let model = try! decoderRange.decode(InfoKey.self, from: jsonDataRange)

model.products[0].minParcel
model.products[1].minParcel
model.products[2].minParcel
model.products[3].minParcel
model.products[4].minParcel
model.products[5].minParcel

/////////////////////////////////////////////////////////////////////
let w3 = "🔥 parse like Real"

let jsonString =
"""
{
    "name": "CARTA CRT 120.000,00",
    "valorCarta": 289334.97,
    "valorParcela": 1285.32,
    "valorParcelaSemSeguro": 607.56
}
"""

struct FloatProblem: Codable {
    let name: String
    let letter: Decimal
    let parcel: Decimal
    let noInsurance: Decimal
    
    enum CodingKeys : String, CodingKey {
        case name
        case letter = "valorCarta"
        case parcel = "valorParcela"
        case noInsurance = "valorParcelaSemSeguro"
    }
}

let jsonData = jsonString.data(using: .utf8)!
let decoder = JSONDecoder()
let problem = try! decoder.decode(FloatProblem.self, from: jsonData)
...
let data1 = try! encoder.encode(problem)
print(String(data: data1, encoding: .utf8)!)



let monadicDecoder = MonadicJSONDecoder()
let problemResolved = try! monadicDecoder.decode(FloatProblem.self, from: jsonData)

problemResolved.name
problemResolved.letter
problemResolved.parcel
problemResolved.noInsurance

let data2 = try! encoder.encode(problemResolved)
...
//    "prazoPlano" : 100,
//    "seguro" : false,
//    "valorCarta" : 289334.96999999997,
//    "idPlanoVenda" : 1028,
//    "idModelo" : 1022,
//    "valorParcela" : 45466.959999999999
//}
